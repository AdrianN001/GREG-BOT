...
export default {
    ...
    callback: async ({message,args}) => {
        ...
        let manipulator = new IMAGE_MANIPULATOR( message.author, MODS.SLAP ,message.mentions.users.first()); 
        ...
        {
            manipulator = new IMAGE_MANIPULATOR( message.mentions.users.first()!, MODS.SLAP ,message.mentions.users.last())
        }
