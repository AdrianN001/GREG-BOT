...
export default {
    ...
    callback: async ({message,args}) => {
        ...
        let manipulator = new IMAGE_MANIPULATOR( message.author, MODS.KISS ,message.mentions.users.first()); 
        ...
        {
            manipulator = new IMAGE_MANIPULATOR( message.mentions.users.first()!, MODS.KISS ,message.mentions.users.last())
        }
