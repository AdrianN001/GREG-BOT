...
export default {
    ...
    callback: async ({message,args}) => {
        ...
        let manipulator = new IMAGE_MANIPULATOR( message.author, MODS.SPANK ,message.mentions.users.first()); 
        ...
        {
            manipulator = new IMAGE_MANIPULATOR( message.mentions.users.first()!, MODS.SPANK ,message.mentions.users.last())
        }
